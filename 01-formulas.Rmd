...
-   Función *Beta*: $$B(\alpha,\beta) = \int_{0}^\infty t^{\alpha-1} (1-t)^{\beta-1} dt\qquad B(\alpha,\beta) = \frac{\Gamma(\alpha)\Gamma(\beta)}{\Gamma(\alpha + \beta)} $$
-   Tasa de Riesgo:
...
-   Métricas de ajuste
    ...
    +:================================================================:+:========================================================================================:+
    | $$MAE = \frac{1}{n}\sum_{i=1}^{n} |y_i - \hat{y_i}|$$            | $$MAPE = \frac{100}{n} \sum_{i=1}^{n} \left|\frac{y_i - \hat{y_i}}{y_i}\right|$$         |
    +------------------------------------------------------------------+------------------------------------------------------------------------------------------+
