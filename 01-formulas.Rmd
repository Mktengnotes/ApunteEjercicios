...
-   Métricas de ajuste
    ...
    +--------------------------+-------------------------------------+
    | Métrica de Error         | Métrica de Ajuste / Criterio de     |
    |                          | Información                         |
    +:========================:+:===================================:+
    | \$                       | $$MA                                |
    | $                        | P                                   |
    | MAE = \frac{1}{n}\sum_{i | E                                   |
    | =                        |                                     |
    | 1                        | = \frac{100}{n} \sum_{i=1}^{n} \lef |
    | }^                       | t                                   |
    | {n} |y_i - \hat{y_i}|$\$ | |                                   |
    |                          | \                                   |
    ...
    | \frac{(y_i -             | t                                   |
    |                          | {                                   |
    | \ha                      | NR}} - LL_{\text{R}}) \sim \chi^2$$ |
    | t                        |                                     |
    | {y_i})^2}{\hat{y_i}}\$\$ | \$                                  |
    |                          | $A                                  |
    |                          | IC = -2\ln(L(\hat{\theta})) + 2k$\$ |
    |                          |                                     |
    |                          | \$\$BIC                             |
    |                          |                                     |
    |                          | = -2\ln(L(\hat{\theta})) + k        |
