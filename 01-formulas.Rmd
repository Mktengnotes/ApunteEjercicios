...
| Modelo de Tiempo Continuo  | $\lambda \sim \mathrm{Gamma}(\alpha,r)$       | $\lambda \mid t \sim \mathrm{Gamma}(\alpha+t,\ r+1)$      | $\mathbb{E}[\lambda \mid t] = \dfrac{r+1}{\alpha+t}$             |
| Modelo de Conteo           | $\lambda \sim \mathrm{Gamma}(\alpha,r)$       | $\lambda \mid x \sim \mathrm{Gamma}(\alpha+1,\ r+x)$      | $\mathbb{E}[\lambda \mid x] = \dfrac{r+x}{\alpha+1}$             |
