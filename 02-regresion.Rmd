...
+----------+------------------------------------------------+----------+
| Duración | Duración de la película presentada [en         | 103.32   |
|          | Minutos]                                       |          |
+----------+------------------------------------------------+----------+
| Tipo     | Tipo de película presentada {Acción, Comedia,  | \-       |
|          | Romance, Drama, Terror}                        |          |
+----------+------------------------------------------------+----------+
| Edad     | Restricción de edad de la película {TE, TE+7,  | \-       |
|          | MA+14, MA+18}                                  |          |
+----------+------------------------------------------------+----------+
| Estudio  | Estudio que produjo la película {Dis, WB,      | \-       |
|          | Para, Uni}                                     |          |
+----------+------------------------------------------------+----------+
| Pre      | Presupuesto de la película [en CLP]            | 160      |
| supuesto |                                                | ,200,000 |
+----------+------------------------------------------------+----------+
| Ingreso  | Ingreso recibido por las entradas vendidas en  | 714,500  |
|          | la función [en CLP]                            |          |
+----------+------------------------------------------------+----------+
...
<thead>
<tr>
<th><p>IdFunción<sub>i</sub></p></th>
<th><p>Fecha<sub>i</sub></p></th>
<th><p>Hora<sub>i</sub></p></th>
<th><p>Película<sub>i</sub></p></th>
<th><p>Duración<sub>i</sub></p></th>
<th><p>Tipo<sub>i</sub></p></th>
<th><p>Edad<sub>i</sub></p></th>
<th><p>Estudio<sub>i</sub></p></th>
<th><p>Presupuesto<sub>i</sub></p></th>
<th><p>Ingreso<sub>i</sub></p></th>
</tr>
</thead>
<tbody>
<tr>
<td><p>14156</p></td>
<td><p>23/07/2022</p></td>
<td><p>19:00</p></td>
<td><p>Odín 4</p></td>
<td><p>105</p></td>
<td><p>Acción</p></td>
...
<td><p>23/07/2022</p></td>
<td><p>22:00</p></td>
<td><p>Chillido 5</p></td>
<td><p>132</p></td>
<td><p>Terror</p></td>
<td><p>MA+18</p></td>
<td><p>Para</p></td>
<td><p>135,600,000</p></td>
<td><p>804,300</p></td>
</tr>
<tr>
<td><p>14158</p></td>
<td><p>24/07/2022</p></td>
<td><p>11:00</p></td>
<td><p>Odín 4</p></td>
<td><p>105</p></td>
<td><p>Acción</p></td>
...
<td><p>24/07/2022</p></td>
<td><p>15:30</p></td>
<td><p>Desafiar Barreras</p></td>
<td><p>158</p></td>
<td><p>Romance</p></td>
<td><p>MA+14</p></td>
<td><p>WB</p></td>
<td><p>94,500,000</p></td>
<td><p>569,200</p></td>
</tr>
<tr>
<td><p>14160</p></td>
...
2.  El equipo escogió como variable dependiente el logaritmo de la suma
    ...
    +-------------+-------------+-------------+-------------+-------------+
    |             | Modelo 1    | Modelo 1    | Modelo 2    | Modelo 2    |
...
1.  Nótese que una película puede tener varias funciones y que, debido a
    ...
    +---------+---------+---------+---------+---------+---------+---------+
    | $Pelí   | $Dura   | $       | $       | $Est    | $log(   | $log(   |
    | cula_j$ | ción_j$ | Tipo_j$ | Edad_j$ | udio_j$ | Pre_j)$ | Ing_j)$ |
    +:=======:+:=======:+:=======:+:=======:+:=======:+:=======:+:=======:+
    | Odín 4  | 105     | Acción  | TE+7    | Dis     | 8.55    | 6.43    |
    +---------+---------+---------+---------+---------+---------+---------+
    | C       | 132     | Terror  | MA+18   | Para    | 8.13    | 5.91    |
    | hillido |         |         |         |         |         |         |
    | 5       |         |         |         |         |         |         |
    +---------+---------+---------+---------+---------+---------+---------+
...
+-----------------------------------+-----------------------------------+
| Acreditación                      | Cantidad de puntos acreditados    |
|                                   | por el cliente en el mes $t$      |
+-----------------------------------+-----------------------------------+
| Canje                             | Cantidad de productos canjeados   |
|                                   | por el cliente en el mes $t$      |
+-----------------------------------+-----------------------------------+
| TipoAcreditación                  | Tiendas Propias, Comercios        |
|                                   | Asociados o Tarjeta Bancaria      |
+-----------------------------------+-----------------------------------+
| TipoCanje                         | Producto o Descuento              |
+-----------------------------------+-----------------------------------+
| Promoción                         | 1 si hubo promo o descuentos      |
|                                   | adicionales en el mes $t$         |
+-----------------------------------+-----------------------------------+
| Mail                              | 1 si se avisó estado de cuenta al |
|                                   | cliente via mail en el mes $t$    |
+-----------------------------------+-----------------------------------+
...
4.  Suponga ahora que se han estimado tres especificaciones para
    ...
    |                    |               | $(0.2)$       | $(5.1)$       |
    +--------------------+---------------+---------------+---------------+
    | $f$(Promoción)     | $-$           | $15.1$        | $10.9$        |
    |                    |               | $(6.7)$       | $(4.2)$       |
    +--------------------+---------------+---------------+---------------+
    | $                  | $-$           | $10.1$        | $8.9$ $(2.1)$ |
    | f$(TiendasPropias) |               | $(3.7)$       |               |
    +--------------------+---------------+---------------+---------------+
    | $f$(C              | $-$           | $3.6$ $(2.5)$ | $2.9$ $(2.3)$ |
    | omerciosAsociados) |               |               |               |
    +--------------------+---------------+---------------+---------------+
...
6.  (1 punto) Disconformes con la capacidad de pronóstico de los modelos
    ...
    +-------------+-------------+-------------+-------------+-------------+
    | Propiedad   | Tiene       | Tiene       | Tiene       | Ciudad      |
    |             | Piscina     | Calefacción | Esta        |             |
    |             |             | Central     | cionamiento |             |
    +:===========:+:===========:+:===========:+:===========:+:===========:+
    | A           | Sí          | Sí          | Sí          | Santiago    |
    +-------------+-------------+-------------+-------------+-------------+
...
3.  Para evaluar la capacidad de los modelos para apoyar la gestión del
    ...
    |         |         | 1       |         |         | 2       |         |
    +:=======:+:=======:+:=======:+:=======:+:=======:+:=======:+:=======:+
    |         | **Pesi  | **N     | **Opti  | **Pesi  | **N     | **Opti  |
    |         | mista** | eutro** | mista** | mista** | eutro** | mista** |
    +---------+---------+---------+---------+---------+---------+---------+
    | Tienda  | 316,6   | 345,1   | 392,1   | 318,5   | 352,1   | 387,7   |
    | A01     | (11,8)  | (7,2)   | (12,1)  | (12,2)  | (6,7)   | (10,9)  |
    +---------+---------+---------+---------+---------+---------+---------+
    | Tienda  | 555,8   | 578,8   | 602,2   | 547,6   | 566,3   | 607,7   |
    | A12     | (12,2)  | (8,1)   | (11,8)  | (11,0)  | (9,1)   | (11,6)  |
    +---------+---------+---------+---------+---------+---------+---------+
...
4)  Para una parte del análisis, se consideraron tres modelos de
    ...
    +---------------+---------------+-----------------+-------------------+
    | Variable      | Experiencia   | Resolutividad   | Porcentaje        |
    |               | (Coeficiente) | (Coeficiente)   | Errores           |
    |               |               |                 | (Coeficiente)     |
    +:=============:+:=============:+:===============:+:=================:+
    ...
    +---------------+---------------+-----------------+-------------------+
    | Eficacia      | 0.174 \*\*\*  | 0.155 \*\*\*    | 0.541             |
    | entrada       |               |                 |                   |
    +---------------+---------------+-----------------+-------------------+
    | Eficacia      | 0.100 \*\*\*  | -0.030          | 1.400             |
    | salida        |               |                 |                   |
    +---------------+---------------+-----------------+-------------------+
...
3.  Suponga que se estiman tres modelos simples de regresión lineal para
    ...
    +---------+---------+---------+---------+---------+---------+---------+
    | V       | Modelo  | Modelo  | Modelo  | Modelo  | Modelo  | Modelo  |
    | ariable | 1       | 1 SE    | 2       | 2 SE    | 3       | 3 SE    |
    |         | Coef    |         | Coef    |         | Coef    |         |
    |         | iciente |         | iciente |         | iciente |         |
    +:=======:+:=======:+:=======:+:=======:+:=======:+:=======:+:=======:+
    | $\ln(\  | -0.453  | 0.001   | -0.462  | 0.023   | -0.3983 | 0.024   |
    | text{le |         |         |         |         |         |         |
    | ngth})$ |         |         |         |         |         |         |
    +---------+---------+---------+---------+---------+---------+---------+
    ...
    +---------+---------+---------+---------+---------+---------+---------+
    | Dance   | 2.345   | 0.002   | 0.091   | 0.645   | 0.192   | 0.345   |
    | ability |         |         |         |         |         |         |
    +---------+---------+---------+---------+---------+---------+---------+
...
+------+------+------+------+------+------+------+------+------+
| I    | Date | Hour | NOrd | NOrd | Day  | Mes  | Rain | IM   |
| dZip |      |      | ersC | ersN |      |      |      | ACEC |
+:====:+:====:+:====:+:====:+:====:+:====:+:====:+:====:+:====:+
| 1    | 02   | 8    | 248  | 0    | 2    | 1    | 0    | 0.02 |
| 5217 | /01/ |      |      |      |      |      |      |      |
|      | 2018 |      |      |      |      |      |      |      |
+------+------+------+------+------+------+------+------+------+
| 1    | 02   | 9    | 325  | 0    | 2    | 1    | 0    | 0.02 |
| 5217 | /01/ |      |      |      |      |      |      |      |
|      | 2018 |      |      |      |      |      |      |      |
+------+------+------+------+------+------+------+------+------+
| 1    | 02   | 10   | 331  | 13   | 2    | 1    | 0    | 0.02 |
| 5217 | /01/ |      |      |      |      |      |      |      |
|      | 2018 |      |      |      |      |      |      |      |
+------+------+------+------+------+------+------+------+------+
| 2    | 03   | 8    | 1345 | 1    | 3    | 1    | 0    | 0.02 |
| 3156 | /01/ |      |      |      |      |      |      |      |
|      | 2018 |      |      |      |      |      |      |      |
+------+------+------+------+------+------+------+------+------+
| 2    | 03   | 9    | 1221 | 0    | 3    | 1    | 0    | 0.02 |
| 3156 | /01/ |      |      |      |      |      |      |      |
|      | 2018 |      |      |      |      |      |      |      |
+------+------+------+------+------+------+------+------+------+
| 2    | 03   | 10   | 1436 | 54   | 3    | 1    | 0    | 0.02 |
| 3156 | /01/ |      |      |      |      |      |      |      |
|      | 2018 |      |      |      |      |      |      |      |
+------+------+------+------+------+------+------+------+------+
...
1.  Primero que todo, tenemos que clarificar que la variable dependiente
    ...
    órdenes completadas
    como aquellas que excedieron la capacidad:
...
2.  Incluye:
    ...
    c.  Al agregar efectos fijos por región, el $R^2$ (varianza
        ...
        la demanda se
        explica porque hay regiones que hay más demanda que en otras.
