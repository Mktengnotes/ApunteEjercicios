...
2)  Suponga que se estima el modelo usando el método de la máxima
    ...
    a)  La Figura reporta la distribución beta evaluada en los
        ...
        ![**Figura:** Distribución posterior de la probabilidad de no continuar](images/fig_beta_posterior_v2.png){width="60%"
        fig-align="center"}
...
2)  Para el primer caso:
    ...
    a)  La probabilidad $p$ corresponde al área bajo la curva, que puede
        ...
        ![**Figura:** Distribución posterior con área sombreada](images/fig_beta_posterior_shaded_08_1.png){fig-align="center"
        width="60%"}
